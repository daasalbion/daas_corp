    ...
    $.fn.marquee = function(options) {
        ...
        return this.each(function() {
            ...
            if (typeof options === 'string') {
                //si la opcion pasada es una funcion jquery
                if ($.isFunction(methods[options])) {
                    //Following two IF statements to support public methods
                    if (!$marqueeWrapper) {
                        //se le pasa el control al js que le llama jquerymarquee
            ...
            //setea los atributos del objeto encontrados o pasados por el html a true si los encuentro y false si no
            ...
            //no tiene espacios entre textos si no tiene seteado a true duplicated
            o.gap = o.duplicated ? o.gap : 0;

            //wrap inner content into a div
            //donde crea el marquee temporalmente que envuelve al tag que tiene el objeto marquee
            ...
            //si tiene la opcion de duplicado le agrega al final del texto para que vuelva a salir
            if (o.duplicated) {
            ...
            $marqueeWrapper = $this.find('.js-marquee-wrapper');
            //ak ya tengo seteado $marqueeWrapper
            ...
            if (verticalDir) {
                ...
                //parseInt(cadena, radio) 10 es decimal
            ...
            _rePositionHorizontally = function() {
                //le alinea fuera del div para mostrar despues
            ...
            var animate = function() {
                ...
                if (css3AnimationIsSupported) {
                    ...
                    //Animation iteration event sirve para avisar que ha ocurrido este evento entonces puedan ligar a los eventos
                    //que tiene
