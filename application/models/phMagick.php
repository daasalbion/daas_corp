...
/*--------------    THE GOODIES    -----------------*/
    ...
    /**
	 * Inicializa phMagick
     * @param string $sourceFile The full path for the image
	 * @param string $destinationFile The full path for the newlly created image
	 */
	 ...
	 */
     function resize( $width, $height = 0, $exactDimentions = false){
...
class phMagickTextObject {
	...
	var $pGravity; //ignored in fromString()
	var $pText = '';
